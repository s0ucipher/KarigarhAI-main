  ...
  try {
    ...
    container.innerHTML = `
      <div class="pb-28">
        ...
        <div class="fixed top-3 inset-x-0 max-w-md mx-auto px-4 z-30 flex items-center justify-between pointer-events-none">
          <button id="btn-back-marketplace" class="pointer-events-auto w-9 h-9 rounded-full bg-white/90 backdrop-blur-md shadow-md flex items-center justify-center text-stone-800 hover:bg-white text-xs">
            <i class="fa-solid fa-arrow-left"></i>
          </button>
          <div class="flex items-center gap-2">
            <button id="btn-listen-story" class="pointer-events-auto bg-amber-700/90 text-white text-[11px] font-bold py-1.5 px-3 rounded-full shadow-md backdrop-blur-md flex items-center gap-1.5">
        ...
        <div class="p-4 space-y-4">
          <div>
            ...
            <h1 class="text-base font-black text-stone-900 leading-snug">${p.title || p.name}</h1>
        ...
        <div class="fixed bottom-0 inset-x-0 max-w-md mx-auto bg-white/95 backdrop-blur-md border-t border-stone-200 p-3 z-30 flex items-center gap-2.5 shadow-lg">
